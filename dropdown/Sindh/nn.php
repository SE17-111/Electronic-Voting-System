...
$cnic = $_POST['cnic'];
$sql = "SELECT * FROM selection_criteria where CNIC = '$cnic' and Vote = '0'";
$n1 = 1;
$n2 = 0;
	...
	if($check == 0)
	{
		while($row = mysqli_fetch_array($result))
		{
			...
			{	
				...
				$query = "UPDATE selection_criteria SET Vote = '$n1' WHERE CNIN = '$cnic'";
				?>
	 			<script>
			...
			else ($row['Vote'] == $n1 && $row['CNIC'] == $cnic) 
			{
				$check = 1;
				?>
	 				<script>
